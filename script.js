document.addEventListener('DOMContentLoaded', () => {
    ...
    function fetchAnimals(habitatName) {
        fetch(` https://arcadia-app-backe-d-ik6c.vercel.app/api/animals?habitat=${encodeURIComponent(habitatName)}`, {
            method: 'GET',
    ...
    function fetchAnimalDetails(animalId) {
        fetch(` https://arcadia-app-backe-d-ik6c.vercel.app/api/animal-details?id=${encodeURIComponent(animalId)}`, {
            method: 'GET',
            mode: 'cors',  // Ajout de CORS
            headers: {
                'Content-Type': 'application/json'
