document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadAnimals() {
        fetch('https://app-arcadia-front.vercel.app/api/vet/animals')  // Requête API pour charger les animaux
            .then(response => {
                if (!response.ok) {
    ...
    updateAnimalBtn.addEventListener('click', () => {
        ...
        fetch(`https://app-arcadia-front.vercel.app/api/vet/animals/${selectedAnimalId}`, {
            method: 'PUT',
            headers: {
