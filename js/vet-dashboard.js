document.addEventListener('DOMContentLoaded', () => {
    ...
    function loadAnimals() {
        fetch('https://arcadia-app-backe-d-ik6c.vercel.app/api/vet/animals')  // Requête API pour charger les animaux
            .then(response => {
                if (!response.ok) {
    ...
    updateAnimalBtn.addEventListener('click', () => {
        ...
        fetch(`${apiUrl}https://arcadia-app-backe-d-ik6c.vercel.app/api/vet/animals/${selectedAnimalId}`, {
            method: 'PUT',
            headers: {
